...
protected:
	...
	static void _get_property_list(List<PropertyInfo> *p_list) const;
	static bool _property_can_revert(const StringName &p_name) const;
	static bool _property_get_revert(const StringName &p_name, Variant &r_property) const;
