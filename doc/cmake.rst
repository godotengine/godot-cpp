...
.. code-block::
    ...
    cmake --build . --target godot-cpp.test.template_release
...
.. code-block::
    ...
    cd build-msvc
    cmake .. -DGODOT_ENABLE_TESTING=YES
    cmake --build . -t godot-cpp.test.template_release --config Release
...
.. code-block::
    ...
    cmake --build . -t godot-cpp.test.template_release
...
.. code-block::
    ...
    cmake --build . -t godot-cpp.test.template_release --config Debug
